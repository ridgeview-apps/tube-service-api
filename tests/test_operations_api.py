    ...
    async with db_session_factory() as session:
        session.add_all(
            [
                ...
                WorkerRun(
                    worker_name="line_status_snapshot_worker",
                    started_at=datetime(2026, 6, 16, 8, 10, tzinfo=UTC),
                    finished_at=datetime(2026, 6, 16, 8, 11, tzinfo=UTC),
                    status="success",
                    processed_count=2,
                    error_message=None,
                ),
                WorkerRun(
                    ...
                    started_at=datetime(2026, 6, 16, 8, 12, tzinfo=UTC),
                    finished_at=datetime(2026, 6, 16, 8, 13, tzinfo=UTC),
                    status="success",
                    processed_count=5,
                    error_message=None,
                ),
